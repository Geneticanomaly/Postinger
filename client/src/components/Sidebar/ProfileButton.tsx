...
const Profile = () => {
    ...
    return (
        <section
            className="flex items-center justify-between w-full xl:p-3 p-2 mt-4 rounded-full font-bold 
            text-base cursor-pointer hover:bg-neutral-800 transition duration-200"
        >
