        ...
        <div className={`${isDarkMode && 'dark'}`}>
            <main className="h-svh flex flex-col justify-center gap-4 items-center bg-white dark:bg-neutral-800">
                <section className="flex flex-col gap-3 w-80">
                    <h1 className="font-bold text-6xl dark:text-neutral-100 mb-8">Happening now</h1>
                    <h3 className="font-bold text-xl dark:text-neutral-100 mb-4">Join today.</h3>
                    <button
                        className="flex justify-center items-center gap-2 p-3 rounded-full bg-neutral-white border
                         border-gray-300 cursor-pointertext-neutral-900 font-semibold dark:bg-white"
                    >
                        <img src={googleLogo} alt="Google" className="inline mr-2 w-8" />
                        Sign up with Google
                    </button>
                    <button
                        className="flex justify-center items-center gap-2 p-3 rounded-full border border-gray-300 
                        cursor-pointertext-neutral-900 font-semibold dark:bg-white"
                    >
                    ...
                    <section className="flex flex-col gap-4 mt-12">
                        ...
                        <button
                            className="p-4 rounded-full  bg-neutral-900 text-white font-bold hover:text-blue-400 
                        dark:border dark:border-blue-400"
